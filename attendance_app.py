...
# ID của Google Sheet
sheet_id = "1lFnS_GDVfD_VXjrHN8ASWK1C8eYkTqudSD2poT2yql8"
...
if not data.empty:
    ...
    if query:
        ...
        if not team_info.empty:
            ...
            st.markdown(f"Tên đội: <span style='color: pink; font-weight: bold;'>{team['Tên đội (phải bắt đầu bằng UIT.)']}</span>", unsafe_allow_html=True)
